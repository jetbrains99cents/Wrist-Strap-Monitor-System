# Updated to check for the 'isTest' flag before invalidating the code.
...
async def verify_backup_code(request: VerifyBackupCodeRequest):
    ...
    If 'isTest' is true, the backup code will not be marked as used.
    """
    ...
    # --- NEW: Check the isTest flag before invalidating the code ---
    if not request.isTest:
        ...
        print(f"Test mode: Backup code for user {request.email} was validated but not invalidated.")
